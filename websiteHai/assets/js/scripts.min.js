        ...
        var e = Backbone.Model.extend({
            ...
            , s = Backbone.View.extend({
                ...
                loadProject: function (e) {
                    ...
                    setTimeout(function () {
                        ...
                        // i.$el.addClass("do-close");
                    }, 2000)
                    setTimeout(function () {
                        window.location.href = 'https://youtube.com';
                        // window.open('https://youtube.com','window');
                    }, 1000)
                },
                launchProject: function () {
                    this.$el.css("min-height", $(window).height() + $(window).scrollTop() - this.$el.offset().top),
                        this.$el.addClass("do-launch"),
                        setTimeout(this.onProjectLaunched.bind(this), 1e3)
                },
                closeProject: function () {
                    $(".is-selected", this.$projectNav).removeClass("is-selected"),
                        this.$el.css("min-height", 0),
                        this.$el.addClass("do-close"),
                        this.$el.removeClass("is-launched"),
                        setTimeout(this.onProjectClosed.bind(this), 1e3),
                        this.isLaunched = !1
                },
                onProjectLinkClicked: function (e) {
                    return $(e.currentTarget).closest("li").addClass("is-selected"),
                        this.loadProject($(e.currentTarget).attr("href")),
                        !1
                },
                onProjectCloseClicked: function (e) {
                    ...
                    return $(window).scrollTop() > this.$el.offset().top + .6 * $(window).height() && ($("body,html").animate({
                        ...
                        i = 1e3),
                        setTimeout(this.closeProject.bind(this), i),
                        this.isLaunched = !1,
                        !1
                },
            ...
            , n = Backbone.View.extend({
                ...
                onReadMoreClicked: function (e) {
                    ...
                    return i.last().fadeIn(),
                        1 == i.length && this.$readMoreTrigger.fadeOut(),
                        !1
                }
            })
            , l = Backbone.View.extend({
                ...
                initialize: function () {
                    this.$headline = $(".section__headline", this.$el),
                        ...
                        this.$headline.waypoint(function (e) {
            ...
            , c = Backbone.View.extend({
                ...
                onMenuItemClicked: function (e) {
                    ...
                    return this.$trigger.removeClass("is-closeable"),
                        $("html,body").animate({
                ...
                onTriggerClicked: function (e) {
                    return "s" == Breakpoints.getBreakpoint() && (this.$trigger.toggleClass("is-closeable"),
                ...
                onWindowScroll: function (e) {
                    var i = this
                        ...
                        , o = this.scrollTop - t;
                    o > 40 ? this.$trigger.addClass("is-visible") : -40 > o && this.$trigger.removeClass("is-visible"),
                        this.$menuItems.each(function () {
                            var e = $(this).attr("href");
                            if ($(e).offset().top <= t + $(window).height()) {
                                var o = $(this).attr("href").replace("#", "");
                                return i.$menuItems.removeClass("is-active"),
                                    $(this).addClass("is-active"),
                                    i.currentSection != o && (i.currentSection = o,
                                        $(window).trigger("section-changed", [o])),
                                    !1
                            }
                        }),
                        t == $(document).height() - $(window).height() && this.$trigger.addClass("is-visible"),
                        0 == t && this.$trigger.addClass("is-visible"),
            ...
            , a = Backbone.View.extend({
                ...
                onOverlayTriggerClicked: function (e) {
                    return e.preventDefault(),
                        $(e.currentTarget).toggleClass("is-triggered"),
                        $($(e.currentTarget).attr("href")).toggleClass("is-visible"),
                        !1
                },
                onCloseableClicked: function (e) {
                    return e.preventDefault(),
                        $(e.currentTarget).removeClass("is-closeable").off("click", this.onCloseableClicked),
