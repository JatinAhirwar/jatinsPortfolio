!function(t, e) {
    ...
    function c(t, e, n, i) {
        if (rt.acceptData(t)) {
            var r, o, s = rt.expando, a = t.nodeType, u = a ? rt.cache : t, l = a ? t[s] : t[s] && s;
            if (l && u[l] && (i || u[l].data) || void 0 !== n || "string" != typeof e)
                return l || (l = a ? t[s] = V.pop() || rt.guid++ : s),
                u[l] || (u[l] = a ? {} : {
                    toJSON: rt.noop
                }),
        ...
        if (rt.acceptData(t)) {
            ...
            if (s[a]) {
                if (e && (i = n ? s[a] : s[a].data)) {
                    ...
                    for (; r--; )
                        delete i[e[r]];
                    if (n ? !l(i) : !rt.isEmptyObject(i))
                        return
                }
                (n || (delete s[a].data,
                l(s[a]))) && (o ? rt.cleanData([t], !0) : nt.deleteExpando || s != s.window ? delete s[a] : s[a] = null)
            }
        }
    }
    function d() {
    ...
    function C(t, e) {
        ...
        if (1 === e.nodeType) {
            ...
            nt.html5Clone && t.innerHTML && !rt.trim(e.innerHTML) && (e.innerHTML = t.innerHTML)) : "input" === n && Dt.test(t.type) ? (e.defaultChecked = e.checked = t.checked,
    ...
    function k(t) {
        var e = pt
          , n = Zt[t];
        return n || (n = S(t, e),
        "none" !== n && n || (Kt = (Kt || rt("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement),
        e = (Kt[0].contentWindow || Kt[0].contentDocument).document,
        e.write(),
        e.close(),
        n = S(t, e),
        Kt.detach()),
    ...
    function A(t, e) {
        for (var n, i, r, o = [], s = 0, a = t.length; a > s; s++)
            ...
            "" === i.style.display && At(i) && (o[s] = rt._data(i, "olddisplay", k(i.nodeName)))) : (r = At(i),
    ...
    function D(t, e, n, i, r) {
        for (var o = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, s = 0; 4 > o; o += 2)
            "margin" === n && (s += rt.css(t, n + _t[o], !0, r)),
            i ? ("content" === n && (s -= rt.css(t, "padding" + _t[o], !0, r)),
            "margin" !== n && (s -= rt.css(t, "border" + _t[o] + "Width", !0, r))) : (s += rt.css(t, "padding" + _t[o], !0, r),
            "padding" !== n && (s += rt.css(t, "border" + _t[o] + "Width", !0, r)));
        return s
    }
    function j(t, e, n) {
        var i = !0
    ...
    function F(t, e, n) {
        var i, r, o, s, a, u, l, c, h = this, d = {}, f = t.style, p = t.nodeType && At(t), v = rt._data(t, "fxshow");
        ...
        l = rt.css(t, "display"),
        c = "none" === l ? rt._data(t, "olddisplay") || k(t.nodeName) : l,
        "inline" === c && "none" === rt.css(t, "float") && (nt.inlineBlockNeedsLayout && "inline" !== k(t.nodeName) ? f.zoom = 1 : f.display = "inline-block")),
        ...
        if (rt.isEmptyObject(d))
            "inline" === ("none" === l ? k(t.nodeName) : l) && (f.display = l);
        else {
            v ? "hidden"in v && (p = v.hidden) : v = rt._data(t, "fxshow", {}),
            o && (v.hidden = !p),
    ...
    function O(t, e, n) {
        var i, r, o = 0, s = ye.length, a = rt.Deferred().always(function() {
            ...
            if (r)
                return !1;
            for (var e = fe || L(), n = Math.max(0, l.startTime + l.duration - e), i = n / l.duration || 0, o = 1 - i, s = 0, u = l.tweens.length; u > s; s++)
                l.tweens[s].run(o);
        ...
        a--); u > a; a++)
            if (null != (r = arguments[a]))
                for (i in r)
                    t = s[i],
                    n = r[i],
                    s !== n && (l && n && (rt.isPlainObject(n) || (e = rt.isArray(n))) ? (e ? (e = !1,
    ...
    rt.extend({
        ...
        makeArray: function(t, e) {
            var i = e || [];
            return null != t && (n(Object(t)) ? rt.merge(i, "string" == typeof t ? [t] : t) : Y.call(i, t)),
            i
        },
    ...
    var lt = function(t) {
        function e(t, e, n, i) {
            ...
            if ((e ? e.ownerDocument || e : H) !== P && j(e),
            e = e || P,
            n = n || [],
            a = e.nodeType,
            ...
            if (!i && M) {
                ...
                if (w.qsa && (!q || !q.test(t))) {
                    ...
                    if (v)
                        try {
                            return K.apply(n, p.querySelectorAll(v)),
                            n
                        } catch (g) {} finally {
        ...
        function m(t, e, n, r, o, s) {
            ...
            o && !o[z] && (o = m(o, s)),
            i(function(i, s, a, u) {
                var l, c, h, d = [], f = [], p = s.length, m = i || v(e || "*", a.nodeType ? [a] : a, []), y = !t || !i && e ? m : g(m, d, t, a, u), b = n ? o || (i ? t : p || r) ? [] : s : y;
                if (n && n(y, b, a, u),
                r)
                    for (l = g(b, f),
                    r(l, [], a, u),
                ...
                if (i) {
                    if (o || t) {
                        ...
                        for (c = b.length; c--; )
                            (h = b[c]) && (l = o ? tt(i, h) : d[c]) > -1 && (i[l] = !(s[l] = h))
                    }
                } else
        ...
        function b(t, n) {
            var r = n.length > 0
              ...
              , s = function(i, s, a, u, l) {
                var c, h, d, f = 0, p = "0", v = i && [], m = [], y = A, b = i || o && E.find.TAG("*", l), x = R += null == y ? 1 : Math.random() || .1, w = b.length;
                ...
                r && p !== f) {
                    ...
                    if (i) {
                        if (f > 0)
                            for (; p--; )
                                v[p] || m[p] || (m[p] = J.call(u));
                        m = g(m)
                    }
                    K.apply(u, m),
                    l && !i && m.length > 0 && f + n.length > 1 && e.uniqueSort(u)
                }
                return l && (R = x,
                A = y),
                v
        ...
        var x, w, E, C, S, k, T, _, A, N, D, j, P, L, M, q, F, I, O, z = "sizzle" + 1 * new Date, H = t.document, R = 0, B = 0, W = n(), $ = n(), U = n(), X = function(t, e) {
            return t === e && (D = !0),
            0
        }, Q = 1 << 31, V = {}.hasOwnProperty, G = [], J = G.pop, Y = G.push, K = G.push, Z = G.slice, tt = function(t, e) {
            for (var n = 0, i = t.length; i > n; n++)
                if (t[n] === e)
                    return n;
            return -1
        }, et = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", nt = "[\\x20\\t\\r\\n\\f]", it = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", rt = it.replace("w", "w#"), ot = "\\[" + nt + "*(" + it + ")(?:" + nt + "*([*^$|!~]?=)" + nt + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + rt + "))|)" + nt + "*\\]", st = ":(" + it + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + ot + ")*)|.*)\\)|)", at = new RegExp(nt + "+","g"), ut = new RegExp("^" + nt + "+|((?:^|[^\\\\])(?:\\\\.)*)" + nt + "+$","g"), lt = new RegExp("^" + nt + "*," + nt + "*"), ct = new RegExp("^" + nt + "*([>+~]|" + nt + ")" + nt + "*"), ht = new RegExp("=" + nt + "*([^\\]'\"]*?)" + nt + "*\\]","g"), dt = new RegExp(st), ft = new RegExp("^" + rt + "$"), pt = {
            ID: new RegExp("^#(" + it + ")"),
            CLASS: new RegExp("^\\.(" + it + ")"),
        ...
        }, vt = /^(?:input|select|textarea|button)$/i, gt = /^h\d$/i, mt = /^[^{]+\{\s*\[native \w/, yt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, bt = /[+~]/, xt = /'|\\/g, wt = new RegExp("\\\\([\\da-f]{1,6}" + nt + "?|(" + nt + ")|.)","ig"), Et = function(t, e, n) {
            var i = "0x" + e - 65536;
        ...
        j = e.setDocument = function(t) {
            ...
            F = [],
            q = [],
            (w.qsa = mt.test(i.querySelectorAll)) && (r(function(t) {
                L.appendChild(t).innerHTML = "<a id='" + z + "'></a><select id='" + z + "-\f]' msallowcapture=''><option selected=''></option></select>",
                t.querySelectorAll("[msallowcapture^='']").length && q.push("[*^$]=" + nt + "*(?:''|\"\")"),
                t.querySelectorAll("[selected]").length || q.push("\\[" + nt + "*(?:value|" + et + ")"),
                t.querySelectorAll("[id~=" + z + "-]").length || q.push("~="),
                t.querySelectorAll(":checked").length || q.push(":checked"),
                t.querySelectorAll("a#" + z + "+*").length || q.push(".#.+[+~]")
            }),
            r(function(t) {
            ...
            X = e ? function(t, e) {
                ...
                1 & n || !w.sortDetached && e.compareDocumentPosition(t) === n ? t === i || t.ownerDocument === H && O(H, t) ? -1 : e === i || e.ownerDocument === H && O(H, e) ? 1 : N ? tt(N, t) - tt(N, e) : 0 : 4 & n ? -1 : 1)
            }
            : function(t, e) {
                if (t === e)
                    return D = !0,
                ...
                if (!o || !a)
                    return t === i ? -1 : e === i ? 1 : o ? -1 : a ? 1 : N ? tt(N, t) - tt(N, e) : 0;
                if (o === a)
                    return s(t, e);
        ...
        e.matchesSelector = function(t, n) {
            ...
            n = n.replace(ht, "='$1']"),
            !(!w.matchesSelector || !M || F && F.test(n) || q && q.test(n)))
                try {
                    var i = I.call(t, n);
        ...
        E = e.selectors = {
            ...
            preFilter: {
                ATTR: function(t) {
                    return t[1] = t[1].replace(wt, Et),
                    t[3] = (t[3] || t[4] || t[5] || "").replace(wt, Et),
                    "~=" === t[2] && (t[3] = " " + t[3] + " "),
                    t.slice(0, 4)
                },
                CHILD: function(t) {
                ...
                PSEUDO: function(t) {
                    var e, n = !t[6] && t[2];
                    return pt.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && dt.test(n) && (e = k(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e),
                    t[2] = n.slice(0, e)),
                    t.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(t, e, n, i, r) {
                    ...
                    : function(e, n, u) {
                        var l, c, h, d, f, p, v = o !== s ? "nextSibling" : "previousSibling", g = e.parentNode, m = a && e.nodeName.toLowerCase(), y = !u && !a;
                        if (g) {
                            if (o) {
                                for (; v; ) {
                                    for (h = e; h = h[v]; )
                            ...
                            s && y) {
                                ...
                                f = l[0] === R && l[1],
                                d = l[0] === R && l[2],
                                h = f && g.childNodes[f]; h = ++f && h && h[v] || (d = f = 0) || p.pop(); )
                                    if (1 === h.nodeType && ++d && h === e) {
                                        c[t] = [R, f, d];
                                        break
                                    }
                            } else if (y && (l = (e[z] || (e[z] = {}))[t]) && l[0] === R)
                                d = l[1];
                            else
                                for (; (h = ++f && h && h[v] || (d = f = 0) || p.pop()) && ((a ? h.nodeName.toLowerCase() !== m : 1 !== h.nodeType) || !++d || (y && ((h[z] || (h[z] = {}))[t] = [R, d]),
                                h !== e)); )
                                    ;
                            return d -= r,
                            d === i || d % i === 0 && d / i >= 0
        ...
        for (x in {
            ...
            E.pseudos[x] = u(x);
        return h.prototype = E.filters = E.pseudos,
        E.setFilters = new h,
        ...
        _ = e.select = function(t, e, n, i) {
            ...
            1 === h.length) {
                ...
                o.length > 2 && "ID" === (s = o[0]).type && w.getById && 9 === e.nodeType && M && E.relative[o[1].type]) {
                    if (e = (E.find.ID(s.matches[0].replace(wt, Et), e) || [])[0],
                    !e)
                        return n;
                    l && (e = e.parentNode),
            ...
            return (l || T(t, h))(i, e, !M, n, bt.test(t) && c(e.parentNode) || e),
            n
        }
        ,
    ...
    var ft, pt = t.document, vt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, gt = rt.fn.init = function(t, e) {
        var n, i;
        if (!t)
            return this;
        if ("string" == typeof t) {
            if (n = "<" === t.charAt(0) && ">" === t.charAt(t.length - 1) && t.length >= 3 ? [null, t, null] : vt.exec(t),
            !n || !n[1] && e)
    ...
    rt.Callbacks = function(t) {
        ...
        var e, n, i, r, s, a, u = [], l = !t.once && [], c = function(o) {
            ...
            e = !1,
            u && (l ? l.length && c(l.shift()) : n ? u = [] : h.disable())
        }, h = {
            add: function() {
                if (u) {
                    var i = u.length;
            ...
            remove: function() {
                return u && rt.each(arguments, function(t, n) {
                    for (var i; (i = rt.inArray(n, u, i)) > -1; )
                        u.splice(i, 1),
                        e && (r >= i && r--,
                        s >= i && s--)
                }),
    ...
    rt.extend({
        ...
        when: function(t) {
            var e, n, i, r = 0, o = G.call(arguments), s = o.length, a = 1 !== s || t && rt.isFunction(t.promise) ? s : 0, u = 1 === a ? t : rt.Deferred(), l = function(t, n, i) {
                return function(r) {
                    n[t] = this,
            ...
            if (s > 1)
                ...
                n = new Array(s),
                i = new Array(s); s > r; r++)
                    o[r] && rt.isFunction(o[r].promise) ? o[r].promise().done(l(r, i, o)).fail(u.reject).progress(l(r, n, e)) : --a;
    ...
    rt(function() {
        ...
        typeof e.style.zoom !== Ct && (e.style.cssText = "display:inline;margin:0;border:0;padding:1px;width:1px;zoom:1",
    ...
    rt.event = {
        ...
        add: function(t, e, n, i, r) {
            ...
            if (g) {
                ...
                a = e.length; a--; )
                    ...
                    (d = s[f]) || (d = s[f] = [],
                    d.delegateCount = 0,
                    l.setup && l.setup.call(t, i, p, c) !== !1 || (t.addEventListener ? t.addEventListener(f, c, !1) : t.attachEvent && t.attachEvent("on" + f, c))),
                    l.add && (l.add.call(t, h),
            ...
            if (g && (c = g.events)) {
                ...
                l = e.length; l--; )
                    ...
                    f) {
                        ...
                        u = o = d.length; o--; )
                            s = d[o],
                            !r && v !== s.origType || n && n.guid !== s.guid || a && !a.test(s.namespace) || i && i !== s.selector && ("**" !== i || !s.selector) || (d.splice(o, 1),
                            s.selector && d.delegateCount--,
                            h.remove && h.remove.call(t, s));
                        u && !d.length && (h.teardown && h.teardown.call(t, p, g.handle) !== !1 || rt.removeEvent(t, f, g.handle),
                        delete c[f])
                    } else
                        for (f in c)
                            rt.event.remove(t, f + e[l], n, i, !0);
                rt.isEmptyObject(c) && (delete g.handle,
                rt._removeData(t, "events"))
            }
        },
        trigger: function(e, n, i, r) {
            var o, s, a, u, l, c, h, d = [i || pt], f = et.call(e, "type") ? e.type : e, p = et.call(e, "namespace") ? e.namespace.split(".") : [];
            if (a = c = i = i || pt,
            ...
            r || !l.trigger || l.trigger.apply(i, n) !== !1)) {
                ...
                if (e.type = f,
                !r && !e.isDefaultPrevented() && (!l._default || l._default.apply(d.pop(), n) === !1) && rt.acceptData(i) && s && i[f] && !rt.isWindow(i)) {
                    c = i[s],
                    c && (i[s] = null),
        ...
        dispatch: function(t) {
            t = rt.event.fix(t);
            var e, n, i, r, o, s = [], a = G.call(arguments), u = (rt._data(this, "events") || {})[t.type] || [], l = rt.event.special[t.type] || {};
            if (a[0] = t,
        ...
        fix: function(t) {
            ...
            for (s || (this.fixHooks[r] = s = Lt.test(r) ? this.mouseHooks : Pt.test(r) ? this.keyHooks : {}),
    ...
    : function(t, e, n) {
        var i = "on" + e;
        t.detachEvent && (typeof t[i] === Ct && (t[i] = null),
        t.detachEvent(i, n))
    }
    ,
    ...
    rt.extend({
        clone: function(t, e, n) {
            ...
            if (nt.html5Clone || rt.isXMLDoc(t) || !Ot.test("<" + t.nodeName + ">") ? o = t.cloneNode(!0) : (Yt.innerHTML = t.outerHTML,
            Yt.removeChild(o = Yt.firstChild)),
        ...
        buildFragment: function(t, e, n, i) {
            for (var r, o, s, a, u, l, c, h = t.length, d = v(e), f = [], p = 0; h > p; p++)
                ...
                o || 0 === o)
                    if ("object" === rt.type(o))
                        ...
                        c = Gt[u] || Gt._default,
                        a.innerHTML = c[1] + o.replace(Ht, "<$1></$2>") + c[2],
                        r = c[0]; r--; )
                            a = a.lastChild;
                        if (!nt.leadingWhitespace && zt.test(o) && f.push(e.createTextNode(zt.exec(o)[0])),
                        !nt.tbody)
                            for (o = "table" !== u || Bt.test(o) ? "<table>" !== c[1] || Bt.test(o) ? 0 : a : a.firstChild,
                            r = o && o.childNodes.length; r--; )
                                rt.nodeName(l = o.childNodes[r], "tbody") && !l.childNodes.length && o.removeChild(l);
            ...
            nt.appendChecked || rt.grep(g(f, "input"), m),
            p = 0; o = f[p++]; )
        ...
        cleanData: function(t, e) {
            for (var n, i, r, o, s = 0, a = rt.expando, u = rt.cache, l = nt.deleteExpando, c = rt.event.special; null != (n = t[s]); s++)
                ...
                o = r && u[r])) {
                    ...
                    u[r] && (delete u[r],
                    l ? delete n[a] : typeof n.removeAttribute !== Ct ? n.removeAttribute(a) : n[a] = null,
                    V.push(r))
                }
        }
    }),
    rt.fn.extend({
        ...
        domManip: function(t, e) {
            t = J.apply([], t);
            var n, i, r, o, s, a, u = 0, l = this.length, c = this, h = l - 1, d = t[0], f = rt.isFunction(d);
            if (f || l > 1 && "string" == typeof d && !nt.checkClone && Ut.test(d))
                return this.each(function(n) {
                    var i = c.eq(n);
                    f && (t[0] = d.call(this, n, i.html())),
                    i.domManip(t, e)
                });
            if (l && (a = rt.buildFragment(t, this[0].ownerDocument, !1, this),
            n = a.firstChild,
            ...
            n)) {
                ...
                if (r)
                    ...
                    u = 0; r > u; u++)
                        i = o[u],
                        Xt.test(i.type || "") && !rt._data(i, "globalEval") && rt.contains(s, i) && (i.src ? rt._evalUrl && rt._evalUrl(i.src) : rt.globalEval((i.text || i.textContent || i.innerHTML || "").replace(Vt, "")));
                a = n = null
            }
            return this
        }
    ...
    !function() {
        ...
        nt.shrinkWrapBlocks = function() {
            ...
            i.style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px",
            n.appendChild(i).appendChild(e),
            typeof e.style.zoom !== Ct && (e.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:1px;width:1px;zoom:1",
    ...
    var te, ee, ne = /^margin/, ie = new RegExp("^(" + Tt + ")(?!px)[a-z%]+$","i"), re = /^(top|right|bottom|left)$/;
    ...
    !function() {
        function e() {
            ...
            e.style.width = "1px",
            u = !parseFloat((t.getComputedStyle(r, null) || {}).marginRight),
            e.removeChild(r)),
    ...
    rt.extend({
        ...
        style: function(t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                if (e = rt.cssProps[a] || (rt.cssProps[a] = _(u, a)),
                s = rt.cssHooks[e] || rt.cssHooks[a],
                void 0 === n)
                    return s && "get"in s && void 0 !== (r = s.get(t, !1, i)) ? r : u[e];
                if (o = typeof n,
                "string" === o && (r = le.exec(n)) && (n = (r[1] + 1) * r[2] + parseFloat(rt.css(t, e)),
                o = "number"),
                null != n && n === n && ("number" !== o || rt.cssNumber[a] || (n += "px"),
                nt.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (u[e] = "inherit"),
    ...
    rt.fx = P.prototype.init,
    rt.fx.step = {};
    var fe, pe, ve = /^(?:toggle|show|hide)$/, ge = new RegExp("^(?:([+-])=|)(" + Tt + ")([a-z%]*)$","i"), me = /queueHooks$/, ye = [F], be = {
        "*": [function(t, e) {
            ...
            select: {
                get: function(t) {
                    for (var e, n, i = t.options, r = t.selectedIndex, o = "select-one" === t.type || 0 > r, s = o ? null : [], a = o ? r + 1 : i.length, u = 0 > r ? a : o ? r : 0; a > u; u++)
                        if (n = i[u],
                        !(!n.selected && u !== r || (nt.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && rt.nodeName(n.parentNode, "optgroup"))) {
                            if (e = rt(n).val(),
                            o)
                                return e;
                            s.push(e)
    ...
    var we, Ee, Ce = rt.expr.attrHandle, Se = /^(?:checked|selected)$/i, ke = nt.getSetAttribute, Te = nt.input;
    rt.fn.extend({
        attr: function(t, e) {
    ...
    rt.extend({
        attr: function(t, e, n) {
            ...
            return t && 3 !== o && 8 !== o && 2 !== o ? typeof t.getAttribute === Ct ? rt.prop(t, e, n) : (1 === o && rt.isXMLDoc(t) || (e = e.toLowerCase(),
            i = rt.attrHooks[e] || (rt.expr.match.bool.test(e) ? Ee : we)),
        ...
        removeAttr: function(t, e) {
            ...
            if (o && 1 === t.nodeType)
                for (; n = o[r++]; )
                    i = rt.propFix[n] || n,
                    rt.expr.match.bool.test(n) ? Te && ke || !Se.test(n) ? t[i] = !1 : t[rt.camelCase("default-" + n)] = t[i] = !1 : rt.attr(t, n, ""),
    ...
    Ee = {
        set: function(t, e, n) {
            return e === !1 ? rt.removeAttr(t, n) : Te && ke || !Se.test(n) ? t.setAttribute(!ke && rt.propFix[n] || n, n) : t[rt.camelCase("default-" + n)] = t[n] = !0,
            n
        }
    },
    ...
    rt.fn.extend({
        addClass: function(t) {
            var e, n, i, r, o, s, a = 0, u = this.length, l = "string" == typeof t && t;
            if (rt.isFunction(t))
        ...
        removeClass: function(t) {
            var e, n, i, r, o, s, a = 0, u = this.length, l = 0 === arguments.length || "string" == typeof t && t;
            if (rt.isFunction(t))
                return this.each(function(e) {
        ...
        toggleClass: function(t, e) {
            ...
            : function() {
                if ("string" === n)
                    ...
                    (n === Ct || "boolean" === n) && (this.className && rt._data(this, "__className__", this.className),
    ...
    ;
    var Le, Me, qe = /#.*$/, Fe = /([?&])_=[^&]*/, Ie = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Oe = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, ze = /^(?:GET|HEAD)$/, He = /^\/\//, Re = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Be = {}, We = {}, $e = "*/".concat("*");
    try {
        Me = location.href
    } catch (Ue) {
    ...
    rt.extend({
        ...
        ajax: function(t, e) {
            function n(t, e, n, i) {
                ...
                n && (y = B(h, w, n)),
                y = W(h, y, w, r),
                r ? (h.ifModified && (x = w.getResponseHeader("Last-Modified"),
                x && (rt.lastModified[o] = x),
                x = w.getResponseHeader("etag"),
                x && (rt.etag[o] = x)),
                204 === t || "HEAD" === h.type ? E = "nocontent" : 304 === t ? E = "notmodified" : (E = y.state,
                c = y.data,
                m = y.error,
                r = !m)) : (m = E,
                (t || !E) && (E = "error",
                ...
                w.status = t,
                w.statusText = (e || E) + "",
                r ? p.resolveWith(d, [c, E, w]) : p.rejectWith(d, [w, E, m]),
                w.statusCode(g),
                g = void 0,
                u && f.trigger(r ? "ajaxSuccess" : "ajaxError", [w, h, r ? c : m]),
                v.fireWith(d, [w, E]),
            ...
            t = void 0),
            e = e || {};
            var i, r, o, s, a, u, l, c, h = rt.ajaxSetup({}, e), d = h.context || h, f = h.context && (d.nodeType || d.jquery) ? rt(d) : rt.event, p = rt.Deferred(), v = rt.Callbacks("once memory"), g = h.statusCode || {}, m = {}, y = {}, b = 0, x = "canceled", w = {
                readyState: 0,
            ...
            if (p.promise(w).complete = v.add,
            w.success = w.done,
            w.error = w.fail,
            h.url = ((t || h.url || Me) + "").replace(qe, "").replace(He, Le[1] + "//"),
            h.type = e.method || e.type || h.method || h.type,
            h.dataTypes = rt.trim(h.dataType || "*").toLowerCase().match(bt) || [""],
            null == h.crossDomain && (i = Re.exec(h.url.toLowerCase()),
            h.crossDomain = !(!i || i[1] === Le[1] && i[2] === Le[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === (Le[3] || ("http:" === Le[1] ? "80" : "443")))),
            ...
            delete h.data),
            h.cache === !1 && (h.url = Fe.test(o) ? o.replace(Fe, "$1_=" + De++) : o + (je.test(o) ? "&" : "?") + "_=" + De++)),
            ...
            w.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + $e + "; q=0.01" : "") : h.accepts["*"]);
            for (r in h.headers)
    ...
    rt.ajaxPrefilter("json jsonp", function(e, n, i) {
        ...
        a ? e[a] = e[a].replace(en, "$1" + r) : e.jsonp !== !1 && (e.url += (je.test(e.url) ? "&" : "?") + e.jsonp + "=" + r),
    ...
    rt.offset = {
        setOffset: function(t, e, n) {
            var i, r, o, s, a, u, l, c = rt.css(t, "position"), h = rt(t), d = {};
    ...
    rt.fn.extend({
        offset: function(t) {
            ...
            rt.contains(e, r) ? (typeof r.getBoundingClientRect !== Ct && (i = r.getBoundingClientRect()),
            n = Q(o),
            {
...
jQuery.extend(jQuery.easing, {
    ...
    easeInOutBack: function(t, e, n, i, r, o) {
        return void 0 == o && (o = 1.70158),
        (e /= r / 2) < 1 ? i / 2 * e * e * (((o *= 1.525) + 1) * e - o) + n : i / 2 * ((e -= 2) * e * (((o *= 1.525) + 1) * e + o) + 2) + n
    },
    ...
    function o(e) {
        ...
        function o(t) {
            ...
            t && "object" == typeof t && t.nodeType) {
                ...
                var k = n(e.height);
                return k !== !1 && (o.height = k + (C ? 0 : y + E)),
                o.innerWidth = o.width - (m + w),
                o.innerHeight = o.height - (y + E),
        ...
        function u(e, n) {
            ...
            var i = e.style
              ...
              , o = e.runtimeStyle
              , s = o && o.left;
            return s && (o.left = e.currentStyle.left),
            i.left = n,
            n = i.pixelLeft,
            i.left = r,
            s && (o.left = s),
    ...
    i.filterFindElements = function(t, e) {
        ...
        for (var r = [], o = 0, s = t.length; s > o; o++) {
            ...
            if (i.isElement(a))
                if (e) {
                    n(a, e) && r.push(a);
                    for (var u = a.querySelectorAll(e), l = 0, c = u.length; c > l; l++)
                        r.push(u[l])
                } else
                    r.push(a)
        }
    ...
    return i.htmlInit = function(n, r) {
        e(function() {
            for (var e = i.toDashed(r), s = document.querySelectorAll(".js-" + e), a = "data-" + e + "-options", u = 0, l = s.length; l > u; u++) {
                var c, h = s[u], d = h.getAttribute(a);
                try {
                    c = d && JSON.parse(d)
                } catch (f) {
...
function(t, e) {
    ...
    for (var i, r = 0, o = "webkit moz ms o".split(" "), s = t.requestAnimationFrame, a = t.cancelAnimationFrame, u = 0; u < o.length && (!s || !a); u++)
        i = o[u],
        s = s || t[i + "RequestAnimationFrame"],
        a = a || t[i + "CancelAnimationFrame"] || t[i + "CancelRequestAnimationFrame"];
    s && a || (s = function(e) {
    ...
    return l.positionSlider = function() {
        var t = this.x;
        this.options.wrapAround && this.cells.length > 1 && (t = n.modulo(t, this.slideableWidth),
...
function(t, e) {
    if ("function" == typeof define && define.amd)
        define("flickity/js/flickity", ["classie/classie", "eventEmitter/EventEmitter", "eventie/eventie", "get-size/get-size", "fizzy-ui-utils/utils", "./cell", "./animate"], function(n, i, r, o, s, a, u) {
    ...
    function l(t, e) {
        ...
        this.option(e),
        void this._create()) : void (d && d.error("Bad element for Flickity: " + (n || t)))
    }
    var c = t.jQuery
    ...
    l.createMethods = [],
    o.extend(l.prototype, n.prototype),
    l.prototype._create = function() {
        ...
        l.setUnselectable(this.viewport),
        this._createSlider(),
        (this.options.resize || this.options.watchCSS) && (i.bind(t, "resize", this),
    ...
    l.prototype._positionCells = function(t) {
        ...
        for (var i, r = this.cells.length, o = t; r > o; o++)
            i = this.cells[o],
            i.setPosition(e),
            e += i.size.outerWidth,
    ...
    l.prototype._containCells = function() {
        if (this.options.contain && !this.options.wrapAround && this.cells.length)
            for (var t = this.options.rightToLeft ? "marginRight" : "marginLeft", e = this.options.rightToLeft ? "marginLeft" : "marginRight", n = this.cells[0].size[t], i = this.getLastCell(), r = this.slideableWidth - i.size[e], o = r - this.size.innerWidth * (1 - this.cellAlign), s = r < this.size.innerWidth, a = 0, u = this.cells.length; u > a; a++) {
                var l = this.cells[a];
                l.setDefaultTarget(),
                s ? l.target = r * this.cellAlign : (l.target = Math.max(l.target, this.cursorPosition + n),
                l.target = Math.min(l.target, o))
            }
    }
    ,
    ...
    l.prototype.select = function(t, e) {
        if (this.isActive) {
            ...
            this.cells[t] && (this.selectedIndex = t,
    ...
    l.prototype.getCellElements = function() {
        for (var t = [], e = 0, n = this.cells.length; n > e; e++)
    ...
    l.prototype.getParentCell = function(t) {
        ...
        return e ? e : (t = o.getParent(t, ".flickity-slider > *"),
        this.getCell(t))
    }
    ,
    ...
    ,
    o.debounceMethod(l, "onresize", 150),
    ...
    l.prototype.watchCSS = function() {
        ...
        if (t) {
            ...
            var i = h(this.element, ":after").content;
...
function(t, e) {
    ...
    r.prototype._bindStartEvent = function(e, i) {
        i = void 0 === i ? !0 : !!i;
        var r = i ? "bind" : "unbind";
        t.navigator.pointerEnabled ? n[r](e, "pointerdown", this) : t.navigator.msPointerEnabled ? n[r](e, "MSPointerDown", this) : (n[r](e, "mousedown", this),
        n[r](e, "touchstart", this))
    }
    ,
...
function(t, e) {
    ...
    o.prototype._dragPointerMove = function(t, e) {
        ...
        return !this.isDragging && this.hasDragStarted(r) && this._dragStart(t, e),
        r
    }
    ,
    ...
    ,
    o.getPointerPoint = n.getPointerPoint,
    o
}),
function(t, e) {
    ...
    }) : "object" == typeof exports ? module.exports = e(t, require("desandro-classie"), require("eventie"), require("./flickity"), require("unidragger"), require("fizzy-ui-utils")) : (t.Flickity = t.Flickity || {},
    ...
    var u = {};
    o.extend(u, r.prototype),
    u._createDrag = function() {
    ...
    ,
    u.bindDrag = function() {
        this.options.draggable && !this.isDragBound && (e.add(this.element, "is-draggable"),
    ...
    u.unbindDrag = function() {
        this.isDragBound && (e.remove(this.element, "is-draggable"),
        this.unbindHandles(),
    ...
    u.pointerMove = function(t, e) {
        var n = this._dragPointerMove(t, e);
        this.touchVerticalScrollMove(t, e, n),
        this._dragMove(t, e, n),
    ...
    return u.touchVerticalScrollMove = function(e, n, i) {
        ...
        !o && h[e.type] && !this.isTouchScrolling && Math.abs(i.y) > 10 && (this.startScrollY = t.pageYOffset,
...
function(t, e) {
    "function" == typeof define && define.amd ? define("flickity/js/prev-next-button", ["eventie/eventie", "./flickity", "tap-listener/tap-listener", "fizzy-ui-utils/utils"], function(n, i, r, o) {
        return e(t, n, i, r, o)
    }) : "object" == typeof exports ? module.exports = e(t, require("eventie"), require("./flickity"), require("tap-listener"), require("fizzy-ui-utils")) : (t.Flickity = t.Flickity || {},
    ...
    o.prototype._create = function() {
        ...
        if (e.className = "flickity-prev-next-button",
    ...
    o.prototype.createSVG = function() {
        ...
        return e.setAttribute("transform", n),
        t.appendChild(e),
        t
    }
    ,
...
function(t, e) {
    ...
    t.Flickity.PageDots = e(t, t.eventie, t.Flickity, t.TapListener, t.fizzyUIUtils))
}(window, function(t, e, n, i, r) {
    function o(t) {
        this.parent = t,
        this._create()
    ...
    o.prototype._create = function() {
        ...
        this.parent.on("cellSelect", this.onCellSelect),
        this.on("tap", this.onTap),
        this.on("pointerDown", function(e, n) {
...
function(t, e) {
    "function" == typeof define && define.amd ? define("flickity/js/player", ["eventEmitter/EventEmitter", "eventie/eventie", "./flickity"], function(t, n, i) {
        return e(t, n, i)
    }) : "object" == typeof exports ? module.exports = e(require("wolfy87-eventemitter"), require("eventie"), require("./flickity")) : (t.Flickity = t.Flickity || {},
    ...
    n.prototype.deactivatePlayer = function() {
        this.player.stop(),
        this.isMouseenterBound && (e.unbind(this.element, "mouseenter", this),
        delete this.isMouseenterBound)
    }
    ,
    n.prototype.onmouseenter = function() {
        this.player.pause(),
        e.bind(this.element, "mouseleave", this)
    }
    ,
    n.prototype.onmouseleave = function() {
        this.player.unpause(),
        e.unbind(this.element, "mouseleave", this)
    }
    ,
    n.Player = i,
    i
...
function(t, e) {
    "function" == typeof define && define.amd ? define("flickity/js/add-remove-cell", ["./flickity", "fizzy-ui-utils/utils"], function(n, i) {
        return e(t, n, i)
    }) : "object" == typeof exports ? module.exports = e(t, require("./flickity"), require("fizzy-ui-utils")) : (t.Flickity = t.Flickity || {},
    ...
    e.prototype.remove = function(t) {
        var e, i, r, o = this.getCells(t), s = 0;
        for (e = 0,
        i = o.length; i > e; e++) {
            r = o[e];
...
function(t, e) {
    ...
    n.prototype.navCompanionSelect = function() {
        if (this.navCompanion) {
            ...
            this.selectedIndex == t && (this.navSelectedElement = this.cells[t].element,
    ...
    n.prototype.removeNavSelectedElement = function() {
        this.navSelectedElement && (e.remove(this.navSelectedElement, "is-nav-selected"),
...
function(t, e) {
    ...
    s.prototype.check = function() {
        function t(t, r) {
            return e.options.debug && h && c.log("confirm", t, r),
            e.progress(t),
            n++,
            n === i && e.complete(),
            !0
...
function(t, e) {
    ...
    return e.createMethods.push("_createImagesLoaded"),
...
function() {
    function t(t) {
        ...
        return function(n, i, r, o) {
            ...
            var s = !T(n) && y.keys(n)
              , a = (s || n).length
              , u = t > 0 ? 0 : a - 1;
            return arguments.length < 3 && (r = n[s ? s[u] : u],
            u += t),
            e(n, i, r, s, u, a)
        }
    }
    ...
    function n(t, e, n) {
        return function(i, r, o) {
            ...
            if ("number" == typeof o)
                ...
                i[o] === r ? o : -1;
            if (r !== r)
                return o = e(c.call(i, s, a), y.isNaN),
                o >= 0 ? o + s : -1;
    ...
    y.find = y.detect = function(t, e, n) {
        var i;
        return i = T(t) ? y.findIndex(t, e, n) : y.findKey(t, e, n),
    ...
    y.shuffle = function(t) {
        for (var e, n = T(t) ? t : y.values(t), i = n.length, r = Array(i), o = 0; i > o; o++)
            e = y.random(0, o),
            e !== o && (r[o] = r[e]),
            r[e] = n[o];
        return r
    ...
    y.uniq = y.unique = function(t, e, n, i) {
        ...
        for (var r = [], o = [], s = 0, a = k(t); a > s; s++) {
            ...
            r.push(u)) : y.contains(r, u) || r.push(u)
        }
        return r
    }
    ,
    ...
    ,
    y.unzip = function(t) {
        for (var e = t && y.max(t, k).length || 0, n = Array(e), i = 0; e > i; i++)
            n[i] = y.pluck(t, i);
        return n
    }
    ,
    y.object = function(t, e) {
        for (var n = {}, i = 0, r = k(t); r > i; i++)
    ...
    y.bind = function(t, e) {
        if (v && t.bind === v)
            return v.apply(t, c.call(arguments, 1));
        if (!y.isFunction(t))
    ...
    y.throttle = function(t, e, n) {
        ...
        return function() {
            ...
            a = l,
            o = t.apply(i, r),
            s || (i = r = null)) : s || n.trailing === !1 || (s = setTimeout(u, c)),
            o
        }
    }
    ,
    y.debounce = function(t, e, n) {
        var i, r, o, s, a, u = function() {
            var l = y.now() - s;
            e > l && l >= 0 ? i = setTimeout(u, e - l) : (i = null,
            n || (a = t.apply(o, r),
            i || (o = r = null)))
        };
        return function() {
    ...
    y.mapObject = function(t, e, n) {
        e = x(e, n);
        for (var i, r = y.keys(t), o = r.length, s = {}, a = 0; o > a; a++)
            i = r[a],
            s[i] = e(t[i], i, t);
        return s
    }
    ...
    y.template = function(t, e, n) {
        ...
        t.replace(i, function(e, n, i, s, a) {
            return o += t.slice(r, a).replace(z, H),
            r = a + e.length,
...
function(t) {
    ...
    a.trigger = function(t) {
        if (!this._events)
            return this;
        for (var e = Math.max(0, arguments.length - 1), n = Array(e), i = 0; e > i; i++)
            n[i] = arguments[i + 1];
        return l(p, this._events, t, void 0, n),
        this
    }
    ;
    var p = function(t, e, n, i) {
    ...
    n.extend(y.prototype, a, {
        ...
        fetch: function(t) {
            ...
            return t.success = function(n) {
                return e.set(e.parse(n, t), t) ? (i && i.call(t.context, e, n, t),
        ...
        save: function(t, e, i) {
            ...
            r && !a) {
                ...
                return !1;
            r && a && (this.attributes = n.extend({}, u, r)),
            ...
            return i.success = function(t) {
                ...
                return a && (e = n.extend(r || {}, e)),
                n.isObject(e) && !l.set(e, i) ? !1 : (c && c.call(i.context, l, t, i),
                void l.trigger("sync", l, t, i))
            }
            ,
            H(this, i),
            o = this.isNew() ? "create" : i.patch ? "patch" : "update",
            "patch" !== o || i.attrs || (i.attrs = r),
            s = this.sync(o, this, i),
            r && a && (this.attributes = u),
            s
        },
        destroy: function(t) {
            t = t ? n.clone(t) : {};
    ...
    n.extend(x.prototype, a, {
        ...
        remove: function(t, e) {
            var i, r = !n.isArray(t);
            return t = r ? [t] : n.clone(t),
            e || (e = {}),
            i = this._removeModels(t, e),
            !e.silent && i && this.trigger("update", this, e),
            r ? t[0] : t
        },
        set: function(t, e) {
            e = n.defaults({}, e, w),
            ...
            for (var c = this.comparator && null == l && e.sort !== !1, h = n.isString(this.comparator) ? this.comparator : null, d = [], f = [], p = {}, v = e.add, g = e.merge, m = e.remove, y = !c && v && m ? [] : !1, b = !1, x = 0; x < t.length; x++) {
                ...
                a = this.get(s))
                    ...
                    a.set(s, e),
                    c && !u && a.hasChanged(h) && (u = !0)),
                    t[x] = a;
                else if (v) {
                    if (o = t[x] = this._prepareModel(s, e),
                    !o)
                        continue;
                    d.push(o),
                ...
                b = b || !this.models[x] || o.cid !== this.models[x].cid),
                p[r] = !0)
            }
            if (m) {
                for (var x = 0; x < this.length; x++)
                    p[(o = this.models[x]).cid] || f.push(o);
            ...
            if (d.length || b)
                ...
                null != l)
                    for (var x = 0; x < d.length; x++)
                        this.models.splice(l + x, 0, d[x]);
                else {
                    y && (this.models.length = 0);
                    for (var E = y || d, x = 0; x < E.length; x++)
            ...
            !e.silent) {
                for (var C = null != l ? n.clone(e) : e, x = 0; x < d.length; x++)
                    null != l && (C.index = l + x),
                    (o = d[x]).trigger("add", o, this, C);
                (u || b) && this.trigger("sort", this, e),
    ...
    e.sync = function(t, i, r) {
        ...
        if (r.url || (s.url = n.result(i, "url") || z()),
    ...
    n.extend(M.prototype, a, {
        ...
        start: function(t) {
            ...
            if (!this._hasHashChange && this._wantsHashChange && !this._usePushState) {
                ...
                i.tabIndex = -1;
                var r = document.body;
                this.iframe = r.insertBefore(i, r.firstChild).contentWindow,
        ...
        navigate: function(t, e) {
            ...
            var i = n + t;
            if (t = this.decodeFragment(t.replace(I, "")),
            this.fragment !== t) {
                if (this.fragment = t,
                this._usePushState)
    ...
    e.prototype.refresh = function() {
        ...
        for (var r in t) {
            ...
            for (var s in this.waypoints[r]) {
                var a, u, l, c, h, d = this.waypoints[r][s], f = d.options.offset, p = d.triggerPoint, v = 0, g = null == p;
                d.element !== d.element.window && (v = d.adapter.offset()[o.offsetProp]),
                ...
                d.triggerPoint = v + a - f,
                u = p < o.oldScroll,
                l = d.triggerPoint >= o.oldScroll,
                c = u && l,
                h = !u && !l,
                !g && c ? (d.queueTrigger(o.backward),
                i[d.group.id] = d.group) : !g && h ? (d.queueTrigger(o.forward),
                i[d.group.id] = d.group) : g && o.oldScroll >= d.triggerPoint && (d.queueTrigger(o.forward),
...
function(t, e, n) {
    "object" == typeof module && module && "object" == typeof module.exports ? module.exports = n : (t[e] = n,
    "function" == typeof define && define.amd && define(e, [], function(t) {
        return n
    }))
          ...
          , p = function() {
            for (var t = [], r = [], a = 0; a < e.length; a++) {
                var u = e[a].breakpoint
                  ...
                  , c = e[a].exit || n;
                "*" === u ? (l !== n && t.push(l),
                c !== n && r.push(c)) : g(u) ? (l === n || i[a] || t.push(l),
                i[a] = !0) : (c !== n && i[a] && r.push(c),
                i[a] = !1)
            }
            for (var h = {
                entering: o,
